...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2025 a las 21:16:20
...
(15, 1, 2, 'img/piso_valencia1.jpg', 'Luminoso y reformado', 'Pruebas', 120000.00, '2 hab, buena iluminación', 'Valencia', 1, 80.00, 2, 1, 2, 2005, '2025-11-17 11:56:39', 2),
(16, 1, 6, 'img/1764577480_piso-de-bamboo-mexico.jpg', 'buena vivienda', 'me encanta mi vivienda', 100000000.00, 'buena vivienda', 'sandrápolis', 6, 4.00, 2, 11, 2, 1800, '2025-12-01 09:24:40', 1),
(17, 2, 3, 'img/1764577585_adas.jpeg', 'oficina oficina', 'buena oficina', 500000.00, 'oficina oficina', 'alicante', 1, 5.00, 3, 2, 1, 1895, '2025-12-01 09:26:25', 1);
...
(32, 'fotitooo', 'img/Sin título.jpeg', 'me gusta esta imagen', 16),
(33, 'estar', 'img/adadaa.webp', 'estar de la oficina', 17),
(34, 'prueba', 'img/adadaa.webp', 'anuncio con nueva habitacion', 17);
...
(25, 1, 'oye hey esto es una prueba pssst repito una prueba', 1, 2, NULL, '2025-11-27 21:31:58'),
(26, 4, 'pssst esto es otra prueba más', 1, 2, 1, '2025-11-27 21:35:42'),
(27, 4, 'mkkmkm', 1, 2, 1, '2025-11-27 22:34:26');
...
(2, 'sandra', '$2y$10$jkeZTmyTFVc504KJZ.mWYONNb9Vw3nr46eIDADbByiCXcPMoChYt.', 'sandra@example.com', 2, '1999-04-05', 'Valencia', 1, 'img/sandra.jpg', '2025-11-08 14:20:07', 2),
(3, 'prueba', '$2y$10$9GFhrdc1tyqSgERLquczgeuQ/I5oFXTbBWV7cpUAqe6vmQIO5TTDC', 'prueba@example.com', 3, '2000-01-01', 'PruebaCity', 1, 'img/prueba.jpg', '2025-11-12 14:20:07', 1),
(7, 'inaki', '$2y$10$XYwVgcUKoXAqrh/gTNHk4.uvZgI7gl2Qcgp24BhfMPVwZwFkuKLoW', 'sandra@gmail.com', 2, '2005-08-01', '', NULL, NULL, '2025-12-01 11:44:54', NULL);
...
ALTER TABLE `mensajes`
  ...
  ADD KEY `fk_Mensajes_Usuarios_UsuOrigen` (`UsuOrigen`),
  ADD KEY `fk_Mensajes_Usuarios_UsuDestino` (`UsuDestino`),
...
--
ALTER TABLE `anuncios`
  MODIFY `IdAnuncio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `mensajes`
  MODIFY `IdMensaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
ALTER TABLE `mensajes`
  ...
  ADD CONSTRAINT `fk_Mensajes_TiposMensajes` FOREIGN KEY (`TMensaje`) REFERENCES `tiposmensajes` (`IdTMensaje`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Mensajes_Usuarios_UsuDestino` FOREIGN KEY (`UsuDestino`) REFERENCES `usuarios` (`IdUsuario`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Mensajes_Usuarios_UsuOrigen` FOREIGN KEY (`UsuOrigen`) REFERENCES `usuarios` (`IdUsuario`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `solicitudes`
--
ALTER TABLE `solicitudes`
  ADD CONSTRAINT `fk_Solicitudes_Anuncios` FOREIGN KEY (`Anuncio`) REFERENCES `anuncios` (`IdAnuncio`) ON DELETE SET NULL ON UPDATE CASCADE;
